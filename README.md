...
It is similar to react on the back end. 
Can utilize promises in a simlar way to React.

-   [ ] Describe Middleware?
Middleware is a function that gets executed prior to getting data from the server based on a set of parameters.

-   [ ] Describe a Resource? 
Resources are functions that you can perform CRUD actions on.
